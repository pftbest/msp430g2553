...
pub type FN_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, FCTL2_SPEC, u8, u8, 6, O>;
...
pub type FSSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, FCTL2_SPEC, u8, FSSEL_A, 2, O>;
...
pub type FWKEY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, FCTL2_SPEC, u8, FWKEYW_AW, 8, O>;
