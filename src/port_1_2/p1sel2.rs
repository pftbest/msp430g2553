#[doc = "Reader of register P1SEL2"]
pub type R = crate::R<u8, super::P1SEL2>;
#[doc = "Writer for register P1SEL2"]
pub type W = crate::W<u8, super::P1SEL2>;
#[doc = "Register P1SEL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::P1SEL2 {
    type Type = u8;
    #[inline(always)]
