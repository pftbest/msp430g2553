...
impl core::convert::From<crate::R<P2SEL2_SPEC>> for R {
...
impl core::convert::From<crate::W<P2SEL2_SPEC>> for W {
...
pub struct P2SEL2_R(crate::FieldReader<u8, u8>);
impl P2SEL2_R {
...
impl R {
    ...
    pub fn p2sel2(&self) -> P2SEL2_R {
        P2SEL2_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - P0"]
