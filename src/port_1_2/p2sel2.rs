#[doc = "Reader of register P2SEL2"]
pub type R = crate::R<u8, super::P2SEL2>;
#[doc = "Writer for register P2SEL2"]
pub type W = crate::W<u8, super::P2SEL2>;
#[doc = "Register P2SEL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::P2SEL2 {
    type Type = u8;
    #[inline(always)]
...
pub type P2SEL2_R = crate::R<u8, u8>;
