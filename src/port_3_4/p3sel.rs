...
impl core::convert::From<crate::R<P3SEL_SPEC>> for R {
...
impl core::convert::From<crate::W<P3SEL_SPEC>> for W {
...
pub struct P3SEL_R(crate::FieldReader<u8, u8>);
impl P3SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        P3SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for P3SEL_R {
...
impl R {
    ...
    pub fn p3sel(&self) -> P3SEL_R {
        P3SEL_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - P0"]
