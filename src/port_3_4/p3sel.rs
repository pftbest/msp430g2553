...
impl W {
    ...
    #[doc = "Bits 0:7 - Port 3 Selection register"]
    #[inline(always)]
    pub fn p3sel(&mut self) -> P3SEL_W<0> {
        P3SEL_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
