...
impl core::convert::From<crate::R<P3SEL2_SPEC>> for R {
...
impl core::convert::From<crate::W<P3SEL2_SPEC>> for W {
...
pub struct P3SEL2_R(crate::FieldReader<u8, u8>);
impl P3SEL2_R {
...
impl R {
    ...
    pub fn p3sel2(&self) -> P3SEL2_R {
        P3SEL2_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - P0"]
