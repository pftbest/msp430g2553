...
pub type CCIFG_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, TACCTL2_SPEC, bool, O>;
...
pub type OUTMOD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TACCTL2_SPEC, u8, OUTMOD_A, 3, O>;
...
pub type CCIS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TACCTL2_SPEC, u8, CCIS_A, 2, O>;
...
pub type CM_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, TACCTL2_SPEC, u8, CM_A, 2, O>;
