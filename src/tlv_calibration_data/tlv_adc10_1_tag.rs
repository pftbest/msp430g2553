...
pub type TLV_ADC10_1_TAG_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TLV_ADC10_1_TAG` writer - TLV ADC10_1 TAG register"]
pub type TLV_ADC10_1_TAG_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, TLV_ADC10_1_TAG_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - TLV ADC10_1 TAG register"]
    #[inline(always)]
    pub fn tlv_adc10_1_tag(&mut self) -> TLV_ADC10_1_TAG_W<0> {
        TLV_ADC10_1_TAG_W::new(self)
    }
